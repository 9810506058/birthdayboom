...
export const SPECIAL_BIRTHDAY_CARDS: BirthdayCard[] = [
  {
    ...
    sweetMessage: 'Did you know your smile is literally my favorite view in this entire world? Every time you laugh, my whole day gets 1000 times brighter.',
    subNote: 'Please keep smiling like that forever, my dear💖',
    emojiReaction: '🥰',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    sweetMessage: 'Unlimited tight hugs, forehead kisses, and back rubs whenever you want them. No expiration date, ever.',
...
accentBg: 'bg-rose-50 dark:bg-rose-950/40',
icon: '💌',
envelopeTitle: 'One More Moment With You',
teaser: 'If I could wish for one thing today... ❤️',
sweetMessage:
'If I could have one wish today, it would be to pause time whenever I’m with you. To hold you a little longer, look at your smile a little more, and make a thousand more memories with you🥹💕',
subNote: 'I love you more than words can express, my darling. 💖',
emojiReaction: '💗',
},
  {
    id: 6,
  ...
  },
  {
    ...
    sweetMessage: 'The universe became so much kinder, softer, and more beautiful the exact day you were born',
    subNote: 'Happy Birthday to my kindest baby. 🍰',
    emojiReaction: '🎉',
  },
  {
    id: 9,
